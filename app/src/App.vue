<template>
  <div class="max-w-md mx-auto h-[800px] bg-white border shadow-2xl overflow-hidden relative text-[#1A1A1A]">
    <component :is="currentView" v-bind:active-tab="activeTab" @update:active-tab="val => activeTab = val" />

    <nav class="absolute bottom-0 w-full h-20 bg-white border-t border-gray-200 flex justify-around items-center px-2 z-20">
